...
class Stopwatch extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <TimeElapsed id="timer" timeElapsed={this.props.initialTime + timeElapsed} initialTime={this.props.initialTime} />
      </div>
    );
  }
}
...
class TimeElapsed extends React.Component {
  ...
  render() {
    ...
    const leftImgSrc = '../../assets/images/counters/counter' + left + '.gif';
    const centerImgSrc = '../../assets/images/counters/counter' + center + '.gif'
    const rightImgSrc = '../../assets/images/counters/counter' + right + '.gif';
    return (
